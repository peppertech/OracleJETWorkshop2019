...
3. In the 'my-invoice-timeline-viewModel.js' file, replace the example variable 'self.messageText' with the following content, that you are now going to copy and paste directly, from line 8 to 15, in 'demo.js', from [Single Series Timeline from the Oracle JET Cookbook](https://www.oracle.com/webfolder/technetwork/jet/jetCookbook.html?component=timeline&demo=basicTimeline):
...
4. In the code in step 2 above, you're referring to images. These can be any 32x32 pixel images, or you can download those used in creating these instructions [https://github.com/peppertech/OracleJETWorkshop2019/blob/master/images/images.zip](by clicking here), unzip and put the images in the Web Component's 'resources/images' folder, as shown below:
